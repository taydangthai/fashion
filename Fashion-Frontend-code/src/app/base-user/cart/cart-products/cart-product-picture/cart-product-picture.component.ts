...
@Component({
  selector: 'app-cart-product-picture',
  templateUrl: './cart-product-picture.component.html',
  styleUrls: ['./cart-product-picture.component.css']
})
export class CartProductPictureComponent implements OnInit {
